...
# Embeddings
# ==========================================================
# Uses HuggingFace Inference API — no local model, no torch/sentence-transformers needed.
# Requires HUGGINGFACEHUB_API_TOKEN in your environment / Streamlit secrets.
